...
--   Date and Time:   10:26 Thursday July 25, 2024
--   Exported By:     ADMIN
--   Flashback:       0
...
'<div id="card_#APEX$DOM_ID#" aria-hidden="false" class="{case FLIP_CARD_ACTION/}{when click/}t-click-card {otherwise/}t-hover-card {endcase/}t-CardsRegion #T_STYLE# {if APEX$COMPONENT_CSS_CLASSES/} #APEX$COMPONENT_CSS_CLASSES#{endif/}">',
...
begin
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(6744467510320672678)
,p_plugin_id=>wwv_flow_imp.id(6616776141220842751)
